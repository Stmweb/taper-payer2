...
<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#ffffff;">
  <div style="background:#ffffff;padding:40px 30px;text-align:center;">
    <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6939bfcca75c45675d6c793f/38da31918_ChatGPTImageJan5202603_27_37PM.png" alt="Taper Payer" style="width:220px;height:auto;display:block;margin:0 auto 24px auto;" />
    <div style="border-top:3px solid #3D7BB7;margin-bottom:24px;"></div>
  ...
  <div style="background:#f8fafc;padding:20px 30px;text-align:center;border-top:1px solid #e2e8f0;">
    <p style="color:#94a3b8;font-size:12px;margin:0;">© 2026 Taper Payer LLC · <a href="https://taperpayer.com" style="color:#3D7BB7;text-decoration:none;">taperpayer.com</a> · support@taperpayer.com</p>
  </div>
</div>`
  },
  {
...
<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#ffffff;">
  <div style="background:#ffffff;padding:40px 30px;text-align:center;">
    <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6939bfcca75c45675d6c793f/38da31918_ChatGPTImageJan5202603_27_37PM.png" alt="Taper Payer" style="width:220px;height:auto;display:block;margin:0 auto 24px auto;" />
    <div style="border-top:3px solid #F88F2B;margin-bottom:24px;"></div>
...
<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#ffffff;">
  <div style="background:#ffffff;padding:40px 30px;text-align:center;">
    <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6939bfcca75c45675d6c793f/38da31918_ChatGPTImageJan5202603_27_37PM.png" alt="Taper Payer" style="width:220px;height:auto;display:block;margin:0 auto 24px auto;" />
    <div style="border-top:3px solid #06b6d4;margin-bottom:24px;"></div>
...
<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#ffffff;">
  <div style="background:#ffffff;padding:40px 30px;text-align:center;">
    <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6939bfcca75c45675d6c793f/38da31918_ChatGPTImageJan5202603_27_37PM.png" alt="Taper Payer" style="width:220px;height:auto;display:block;margin:0 auto 24px auto;" />
    <div style="border-top:3px solid #7c3aed;margin-bottom:24px;"></div>
