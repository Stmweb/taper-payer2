...
async function getBankToken() {
  ...
  const scope = 'customers:read customers:write customers:execute accounts:read accounts:execute quotes:read quotes:execute transfers:read transfers:execute counterparties:read counterparties:write counterparties:execute external_bank_accounts:read external_bank_accounts:write external_bank_accounts:execute workflows:read workflows:execute';
