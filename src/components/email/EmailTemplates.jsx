...
<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#ffffff;">
  <div style="background:#ffffff;padding:40px 30px;text-align:center;">
    <img src="https://media.base44.com/images/public/695c31d62d68bbb4ef8cc5b3/f69d212f4_TaperPayerGoodLogo.png" alt="Taper Payer" style="width:320px;height:auto;display:block;margin:0 auto 24px auto;mix-blend-mode:multiply;" />
