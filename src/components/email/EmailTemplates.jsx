...
<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#ffffff;">
  <div style="background:linear-gradient(135deg,#3D7BB7 0%,#61AF39 100%);padding:40px 30px;text-align:center;border-radius:12px 12px 0 0;">
    <img src="https://media.base44.com/images/public/695c31d62d68bbb4ef8cc5b3/074f6eff5_TaperPayerLogoTransparent.png" alt="Taper Payer" style="height:120px;width:auto;max-width:300px;display:block;margin:0 auto 20px auto;object-fit:contain;" />
...
<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#ffffff;">
  <div style="background:#1e293b;padding:40px 30px;text-align:center;border-radius:12px 12px 0 0;">
    <img src="https://media.base44.com/images/public/695c31d62d68bbb4ef8cc5b3/074f6eff5_TaperPayerLogoTransparent.png" alt="Taper Payer" style="height:120px;width:auto;max-width:300px;display:block;margin:0 auto 16px auto;object-fit:contain;" />
