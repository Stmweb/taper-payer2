    ...
    <div className="min-h-screen bg-[#f1f5f9] pb-28">
      ...
      >
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <div>
            <p className="text-white/70 text-xs">Receive-only · BNB Smart Chain</p>
          ...
          <>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-4 mb-4">
              <div className="flex items-center justify-between mb-2">
                <span className="text-slate-500 text-xs font-medium">Your Receive Address</span>
                <button onClick={fetchWallet} className="flex items-center gap-1 text-xs text-slate-400">
                  <RefreshCw className="w-3 h-3" /> Refresh
                </button>
              </div>
              <p className="text-slate-700 text-xs font-mono break-all mb-3">{wallet.address}</p>
              <div className="grid grid-cols-2 gap-2">
                <button onClick={copyAddress} className="flex items-center justify-center gap-1.5 py-2.5 rounded-xl bg-blue-600 text-white text-sm font-semibold">
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-1.5 py-2.5 rounded-xl bg-slate-100 text-slate-700 text-sm font-semibold"
                >
                  <ExternalLink className="w-4 h-4" /> View on BscScan
                </a>
              </div>
              <p className="text-slate-400 text-xs text-center mt-3">
                Share this address to receive BNB, AGNV, USDT, or USDC.
              </p>
            </div>
