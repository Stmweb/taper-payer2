          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div>
              ...
              <ul className="space-y-3 text-slate-300">
                ...
                <li><Link to={createPageUrl('TaperPayerAbout')} className="hover:text-white transition-colors">About</Link></li>
                <li><Link to={createPageUrl('TaperPayerContact')} className="hover:text-white transition-colors">Contact</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-bold mb-4 text-xl">Legal</h4>
              <ul className="space-y-3 text-slate-300">
                ...
                <li><Link to={createPageUrl('TaperPayerCookies')} className="hover:text-white transition-colors">Cookies</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-bold mb-4 text-xl">Support</h4>
              <ul className="space-y-3 text-slate-300">
                <li><Link to={createPageUrl('TaperPayerFAQ')} className="hover:text-white transition-colors">FAQ</Link></li>
              </ul>
            </div>
            <div>
              <p className="text-slate-300">&copy; 2026 Taper Payer LLC. All rights reserved.</p>
            </div>
          </div>
        </div>
      </footer>
